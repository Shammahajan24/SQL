...
create table weapon(
 ...
 insert into weapon(weapon_name,ar_id,ae_id)
  ...
  select heroic_name from Avengers where ar_id=(select ar_id from weapon where weapon_name="suit");
  select weapon_name from weapon where ar_id=(select ar_id from Avengers where heroic_name="Thor");
  select enemy_name from  avengers_enemy where ar_id=(select ar_id from Avengers where heroic_name="Thor");
